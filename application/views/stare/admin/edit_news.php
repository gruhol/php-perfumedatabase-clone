...
<div class="container">
			<div class="row">
				...
				<div class="span9">
					<div class="register">
						<?php $data = array('class' => 'form-horizontal'); echo form_open('admin/edit_news', $data);?>
						...
						<p>Dodaj nową wiadomość na portalu.</p>
							...
							<div class="control-group <?php $content_news_error = form_error('content_news'); if (!$content_news_error == '') echo 'error';?>">
							    ...
							    <div class="controls">
							    <textarea name="content_news" rows="10" cols="80" style="width: 90%"><?php echo $content_news1;?></textarea>
							    </div>
							</div><!--end control-group-->
							...
							<div class="control-group" <?php $add_content_news_error = form_error('add_content_news'); if (!$add_content_news_error == '') echo 'error';?>">
							    ...
							    <div class="controls">
							    <textarea name="add_content_news" rows="15" cols="80" style="width: 90%"><?php echo $add_content_news1;?></textarea>
							    </div>
							</div><!--end control-group-->

							<div class="control-group">
							    <div class="controls">
								    <input class="btn btn-primary" type="submit" name="submit" id="Zapisz" value="Zapisz">
							    </div>
							</div><!--end control-group-->
