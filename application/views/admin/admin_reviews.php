...
<div class="row">
	<div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-5">
            <?php 
                echo $this->lang->line('admin_currently_in_the_database').' '.$howmany.$this->lang->line('admin_one_review');
            ?>
            </div>
            <div class="col-md-7">
                <?php
		...
		if ($reviews == FALSE) {
			...
			foreach ($reviews  as $value) {
                ...
                echo '<td><a class="btn btn-outline-danger btn-sm" href='.site_url("admin/delete_review/$value->id_review").' onClick=\'javascript:return confirm("'.$this->lang->line('admin_are_you_sure_to_delete').': '.$value->id_review.'")\'>'.$this->lang->line('admin_delete').'</a></td>';
                echo '</tr>';
                echo '</tbody>';
            }
            echo '</table>';
