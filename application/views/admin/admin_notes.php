...
<div class="row">
	<div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-5">
            <?php echo $this->lang->line('admin_currently_in_the_database').' '.$howmany.' '.$this->lang->line('admin_more_notes');?>
            </div>
            <div class="col-md-2">
                <a href="<?php echo base_url().'admin/add_note';?>" class="btn btn-success mb-2"><?php echo $this->lang->line('admin_add');?></a>
            </div>
            <div class="col-md-5">
                <?php
		...
		if ($notes == FALSE) {
            ...
            <table class="table table-bordered">
                <thead>
                    ...
                    <th scope="col"><?php echo $this->lang->line('admin_category_note');?></th>
			...
			foreach ($notes  as $value) {
                ...
                echo '<td><a class="btn btn-outline-dark btn-sm" href="/admin/edit_note/'.$value->id_note.'" role="button">Edytuj</a></td>';
