...
<div class="row">
	...
	<div class="col-md-8 my-3">
		...
		<h2 class="display-4">Dostęp tylko dla zalogowanych</h2>
		<?php
...
<div class="row">
	...
	<div class="col-md-4">
		...
		<div class="form-group">
			<div class="col-sm-12">
				<button type="submit" class="btn btn-primary main-button"><?php echo $this->lang->line('users_do_login');?> </button>
			</div>
			<div class="col-sm-12">
	...
	<div class="col-md-4">
		...
		<?php 
			...
			echo anchor('user/add_user',$users_register, array('class' => 'btn'));
		?>
